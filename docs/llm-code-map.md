...
| Curriculum and data      | `hermes-train/src/curriculum.rs`, `data.rs`, `data/`                           | Validate versioned objective stages; stream causal, summarization, retrieval-planning, and contrastive-retrieval data; mask/pad/pack and deterministically shuffle it.                                |
