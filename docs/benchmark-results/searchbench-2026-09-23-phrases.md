...
| Family       | Operation | Clients | Distinct queries | Hermes first-term bounds (QPS) | Hermes certified rare-term bounds (QPS) | Luxir (QPS) |
| ------------ | --------- | ------: | ---------------: | -----------------------------: | --------------------------------------: | ----------: |
...
Hermes exceeds fresh Luxir throughput for low-phrase top-10/top-100 and the
...
- Both Hermes binaries returned identical counts, document IDs and score bits
...
- Peak query-process RSS was approximately 1,137 MiB for either Hermes binary
